...
class Student:
    def __init__(self,root):
        ...
        #bg image
        img3=Image.open(r"D:\Face Recognition Project file\College images/background.jpg")
        ...
        img_left=Image.open(r"D:\Face Recognition Project file\College images/std1.webp")
        ...
        #Current course
        current_course_frame = LabelFrame(Left_frame, bd=2, relief=RIDGE, text="Student Details",font=("times new roman",12, "bold"))
        ...
        dep_combo["values"] = ("Select Department","BCA","BBA","Bcom","BA")
        dep_combo.current(0)
        ...
        course_combo["values"] = ("Select Course","Artificial Intelligence","Finance","Mathametics","Law")
        ...
        year_combo["values"] = ("Select Year","2022-2025","2023-2026","2024-2027","2025-2028","2026-2029")
        ...
        semester_combo = ttk.Combobox(current_course_frame,textvariable=self.var_semester,font=("times new roman",13, "bold"),width=17,state="read only")
        ...
        division_combo = ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",12, "bold"),width=17,state="read only")
        ...
        take_photo_btn = Button(btn_frame1, command=self.generate_dataset,text="Take photo sample",width=17,font=("times new roman",12, "bold"),bg="blue",fg="white")
        take_photo_btn.grid(row=0,column=0 )
        
        update_photo_btn = Button(btn_frame1, text="Update photo sample",width=17,font=("times new roman",12, "bold"),bg="blue",fg="white")
        ...
        img_right=Image.open(r"D:\Face Recognition Project file\College images/studentDetails1.jpg")
    ...
    def add_data(self):
        if self.var_dep.get() == "Select Department" or self.var_name.get() == "" or self.var_id.get() == "":
            ...
            try:
                conn = mysql.connector.connect(host="localhost",username="root",password="Nandan@01",database="face_recognizer")
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Success","Student details has been added successfully", parent=self.root)  # this line not executing

            except Exception as e:
                messagebox.showerror("Error",f"Due ro :{str(e)}",parent=self.root)
    ...
    def delete_data(self):
        if self.var_id.get() == "":
            ...
            try:
                delete=messagebox.askyesno("Student Delete Page", "Do tou want to delete this student", parent=self.root)
                if delete > 0:
                    conn = mysql.connector.connect(host="localhost",username="root",password="Nandan@01",database="face_recognizer")
                    my_cursor = conn.cursor()
        ...
        if self.var_dep.get() == "Select Department" or self.var_name.get() == "" or self.var_id.get() == "":
            ...
            try:
                ...
                for x in myresult:
                    ...
                    face_classofier=cv2.CascadeClassifier("haarcascade_frontalface_default.xml")
                    
                    def face_cropped(img):
                        gray=cv2.cvtColor(img, cv2.COLOR_BGR2BGRA)
                        faces=face_classofier.detectMultiScale(gray,1.3,5)
                        #scaling factor=1.3
                        #minimum neighbor=5
